...
class utils
{
    ...
    public static function addLoadingImages($image)
    {
        ...
        if (Helper::options()->cdn) {
            return 'https://cdn.jsdelivr.net/gh/Ryan-m1/M-Blog@' . themeVersion() . '/assets/img/loading/' . $image . '.gif';
        } else {
    ...
    {
        if (Helper::options()->cdn) {
            return 'https://cdn.jsdelivr.net/gh/Ryan-m1/M-Blog@' . themeVersion() . '/assets/' . $path;
        } else {
