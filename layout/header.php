...
<head>
    ...
    <link rel="stylesheet"
          href="<?php if ($this->options->cdn): echo 'https://cdn.jsdelivr.net/gh/Ryan-m1/M-Blog@' . themeVersion() . '/assets/css/main.min.css'; else:utils::indexTheme('assets/css/main.css'); endif ?>">
    <link rel="stylesheet"
          href="<?php if ($this->options->cdn): echo 'https://cdn.jsdelivr.net/gh/Ryan-m1/M-Blog@' . themeVersion() . '/assets/css/gazeimg.min.css'; else:utils::indexTheme('assets/css/gazeimg.css'); endif ?>">
